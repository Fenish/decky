...
export function StepFields({
    ...
    if (step.kind === "program")
        return <ProgramPicker step={step} onChange={onChange} onError={onError} />;
    if (step.kind === "hotkey") {
                ...
                {auto ? (
                    ...
                    !compact && (
                        <p className="script-detached-note">
                            A free key is reserved for this button. To bind it, start recording the
                            shortcut in the other app, then press Test.
                        </p>
                    )
                ) : (
            ...
            {step.wait !== false ? (
                <label className="script-timeout">
                    ...
                    <input
                        ...
                        value={
                            (step.timeoutMs ?? 30000) > 0 ? (step.timeoutMs ?? 30000) / 1000 : ""
                        }
                        onChange={(event) =>
                            onChange({
                                ...step,
